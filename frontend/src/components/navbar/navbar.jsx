...
import logo from '../../assets/home/largelogo.png'
  ...
  return (
    <div className={styles.navbar}>
      <a className={styles.logo} href="https://techfest.org/">
        <img src={logo} className={styles.image} id={styles.image1}></img>
        <img src={smalllogo} className={styles.image} id={styles.image2}></img>
      </a>
      <div className={styles.navoptions} ref={navRef}>
        ...
        <div className={styles.testibtn}>
          <a href="/testimonials" className={styles.testi}>TESTIMONIALS</a>
          <div className={styles.line}></div>
        </div>
        ...
        <button className={styles.navbtn} id={styles.navclosebtn} onClick={showNavbar}>
          <FaTimes />
        </button>
      </div>
